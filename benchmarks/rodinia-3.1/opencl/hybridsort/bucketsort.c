...
void init_bucketsort(int listsize)
{
    ...
    clGetDeviceIDs(platformID[num-1],CL_DEVICE_TYPE_GPU,0,NULL,&num);
    
    cl_device_id devices[num];
    err = clGetDeviceIDs(platformID[num-1],CL_DEVICE_TYPE_GPU,num,devices,NULL);
//    int gpu = 1;
...
void histogramInit(int listsize) {
    ...
    clGetPlatformInfo(platformID[num-1], CL_PLATFORM_PROFILE,128,name,NULL);
