...
tornadoQuadro GP100parboil-0.2"histo.large*default2««ûÿª¤«/ëclCreateCommandQueue ; GPU ; Quadro GP100
...
LD_LIBRARY_PATH=:/home/abhinav/gpgpu.bechmarks:/usr/local/cuda/lib64 ldd build/opencl_base_default/histo | grep OpenCL
	libOpenCL.so.1 => /usr/local/cuda/lib64/libOpenCL.so.1 (0x00007fa593819000)
LD_LIBRARY_PATH=:/home/abhinav/gpgpu.bechmarks:/usr/local/cuda/lib64 build/opencl_base_default/histo -i /tmp/benchmarks_gpgpu_parboil-0.2k2wima6_/datasets/histo/large/input/img.bin -o /tmp/benchmarks_gpgpu_parboil-0.2k2wima6_/benchmarks/histo/run/large/ref.bmp -- 10000 4
Parboil parallel benchmark suite, version 0.2

Run failed!
*+unknown err code!
make: *** [run] Error 1018«ð×WB¼/***************************************************************************
 *
