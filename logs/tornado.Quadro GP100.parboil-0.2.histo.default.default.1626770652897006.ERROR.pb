...
tornadoQuadro GP100parboil-0.2"histo.default*default2¬«©üØ˜¬/ëclCreateCommandQueue ; GPU ; Quadro GP100
...
LD_LIBRARY_PATH=:/home/abhinav/gpgpu.bechmarks:/usr/local/cuda/lib64 ldd build/opencl_base_default/histo | grep OpenCL
	libOpenCL.so.1 => /usr/local/cuda/lib64/libOpenCL.so.1 (0x00007f9be0719000)
LD_LIBRARY_PATH=:/home/abhinav/gpgpu.bechmarks:/usr/local/cuda/lib64 build/opencl_base_default/histo -i /tmp/benchmarks_gpgpu_parboil-0.2p1f0y6ds/datasets/histo/default/input/img.bin -o /tmp/benchmarks_gpgpu_parboil-0.2p1f0y6ds/benchmarks/histo/run/default/ref.bmp -- 20 4
Parboil parallel benchmark suite, version 0.2

Run failed!
*+unknown err code!
make: *** [run] Error 1018“ÔºWB¼/***************************************************************************
 *
