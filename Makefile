...
libclc_helper: 
	/hdd/abhinav/llvm-project/build/bin/clang -target nvptx64-nvidia-nvcl -cl-std=CL2.0 -c -x cl -emit-llvm -Xclang -finclude-default-header -D__OPENCL_VERSION__ -I./ -include "helper.h" helper.cl -o helper.ll
clean:
