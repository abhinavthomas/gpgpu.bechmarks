...
cl_context CECL_CREATE_CONTEXT_FROM_TYPE(
    cl_context_properties* properties, cl_device_type device_type_unused,
...
#define CECL_PROGRAM(program, num_devices, device_list, options, pfn_notify, \
                     user_data)                                              \
...
#define CECL_CREATE_KERNELS_IN_PROGRAM(program, num_kernels, kernels,     \
                                       num_kernels_ret)                   \
  cecl_create_kernels_in_program(program, #program, num_kernels, kernels, \
                                 #kernels, num_kernels_ret)

#define CECL_MAP_BUFFER(command_queue, buffer, blocking_map__UNUSED__,   \
...
#define CECL_WRITE_BUFFER(command_queue, buffer, blocking_write__UNUSED__, \
                          offset, cb, ptr, num_events_in_wait_list,        \
                          event_wait_list, event)                          \
  cecl_write_buffer(command_queue, buffer, #buffer, offset, cb, ptr,       \
                    num_events_in_wait_list, event_wait_list, event)

#define CECL_SET_KERNEL_ARG(kernel, arg_index, arg_size, arg_value) \
